    ...
    public render() {
        ...
        return (
            <WalkthroughBackground type={screenParams.step}>
                {/* STEP 0 */}
                    ...
                    {screenParams.step === 1 ? (
                        <View style={{flex: 0}}>
                            ...
                            <Typography type={TypographyType.headingPrimary} style={{ width: scale(300), color: '#262628', textAlign: 'center',  fontSize: scale(25) }}>
                    ...
                    {screenParams.step === 2 ? (
                        <Fragment>
                            ...
                            <Typography type={TypographyType.headingPrimary} style={{ width: scale(300), color: 'white', textAlign: 'center', fontSize: scale(25)}}>
                ...
                <View style={{flex: 0,  marginBottom: scale(20), marginTop: scale(5), flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                    {screenParams.step !== 0 ? (
